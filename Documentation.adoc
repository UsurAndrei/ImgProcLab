...
.Poisson Shot noisy image, filtered using Mean Filter
...
.Poisson Shot noisy image, filtered using Median Filter
...
.Poisson Shot noisy image, filtered using Gauss Blur
image::GaussianFilteredPoisson.jpg[]

=== Ερώτημα 6

Στο παρακάτω ερώτημα γίνεται η σύγκριση της αρχικής εικόνας με το τελικό μας αποτέλεσμα κάθε φορά
