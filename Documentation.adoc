...
Παρακάτω η μεθοδολογία που ακολουθήσαμε  και τα αποτελέσματα που λαμβάνουμε για το δεύτερο μέρος της εργασίας.
...
Στο δεύτερο ερώτημα εισάγουμε τον θόρυβο. Για το πρώτο υποερώτημα, αναπτύξαμε τον παρακάτω κώδικα:
